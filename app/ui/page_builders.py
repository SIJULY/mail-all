...
def render_email_list_page(
    ...
    if selected_email:
        ...
        selected_email_data = {
            ...
            "delete_url": url_for("delete_single_email", email_id=selected_email["id"]),
        }
